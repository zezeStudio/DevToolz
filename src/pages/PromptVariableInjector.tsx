      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="flex flex-col h-full bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
            ...
            <div className="flex-1 relative min-h-[300px]">
              <textarea
                ...
                className="absolute inset-0 w-full h-full p-4 resize-none bg-transparent focus:outline-none focus:ring-0 text-slate-900 dark:text-slate-100 font-mono text-sm leading-relaxed"
          ...
          <div className="flex flex-col h-full space-y-6">
            ...
            {/* Variables Form */}
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm flex-1">
                    ...
                    {extractedVariables.map(variable => (
                      <div key={variable} className="flex flex-col">
                        ...
                        <textarea
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 dark:text-white dark:placeholder-slate-500 transition-colors resize-y min-h-[60px]"
                        />
                      </div>
                    ))}
                  </div>
            ...
            {/* Output */}
             <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm flex-1 flex flex-col">
               <div className="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                <span className="font-semibold text-slate-700 dark:text-slate-200">
                  Preview Output
                </span>
