    ...
    <>
      ...
      <div className="max-w-5xl mx-auto space-y-8">
            ...
            {mode === 'single' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
                  <div className="p-5 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 font-mono text-sm"
                      />
                      <button
                  ...
                  <div className="p-5 flex-1 bg-white dark:bg-gray-800 space-y-4">
                    {convertedDate ? (
                      <>
                        <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
                  <div className="p-5 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex flex-col space-y-3">
                      <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                      />
                      <button
                  ...
                  <div className="p-5 flex-1 bg-white dark:bg-gray-800 flex flex-col justify-center space-y-6">
                    {convertedTimestamp ? (
                      <>
                        <div className="text-center">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-40 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 font-mono text-sm resize-y"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 mt-12">
          ...
          <div className="prose prose-cyan max-w-none text-gray-600 dark:text-gray-400">
