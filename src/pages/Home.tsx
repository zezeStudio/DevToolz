      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              ...
              className="block w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-2xl leading-5 bg-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-0 sm:text-lg transition-colors shadow-sm"
        ...
        {filteredTools.length > 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {categoryTools.map((tool) => (
                      <Link
                        key={tool.name}
                        to={tool.path}
                        className="group relative bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col h-full transform hover:-translate-y-1"
                      >
                        ...
                        <p className="text-gray-500 flex-1 mb-6 leading-relaxed">
                          {tool.description}
                        </p>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">{t('home.noResults')}</h3>
            <button 
        ...
        <div className="mt-24 bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-sm text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">{t('home.why.title')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-3">{t('home.why.free.title')}</h4>
              <p className="text-gray-500 leading-relaxed">{t('home.why.free.desc')}</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center mb-4">
                <Shield className="w-6 h-6" />
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-3">{t('home.why.privacy.title')}</h4>
              <p className="text-gray-500 leading-relaxed">{t('home.why.privacy.desc')}</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-3">{t('home.why.fast.title')}</h4>
              <p className="text-gray-500 leading-relaxed">{t('home.why.fast.desc')}</p>
            </div>
          </div>
        </div>
      </div>
