      ...
      <div className="max-w-7xl mx-auto flex flex-col h-full px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
          ...
          <div className="lg:col-span-2 flex flex-col h-full min-h-[600px]">
            {/* Toolbar */}
            <div className="bg-white border border-gray-200 rounded-xl p-3 mb-4 shadow-sm flex flex-wrap gap-2 items-center">
              ...
              <button 
                ...
                title={t('text.undo')} 
                className="p-1.5 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed text-gray-700 rounded-lg transition-colors"
              >
                <Undo2 className="w-4 h-4" />
              </button>
              <div className="w-px h-6 bg-gray-300 mx-1 hidden md:block"></div>
              <button onClick={toUpperCase} className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                {t('text.uppercase')}
              </button>
              <button onClick={toLowerCase} className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                {t('text.lowercase')}
              </button>
              <button onClick={toTitleCase} className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                {t('text.titleCase')}
              </button>
              
              <div className="w-px h-6 bg-gray-300 mx-1 hidden md:block"></div>
              
              <button onClick={removeExtraSpaces} title={t('text.removeSpaces')} className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                <AlignLeft className="w-4 h-4" />
              </button>
              <button onClick={removeEmptyLines} title={t('text.removeEmptyLines')} className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                <AlignJustify className="w-4 h-4" />
              </button>
              <button onClick={sortLines} title={t('text.sortLines')} className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                <ArrowDownAZ className="w-4 h-4" />
              </button>
              <button onClick={reverseText} title={t('text.reverse')} className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                <ArrowLeftRight className="w-4 h-4" />
              </button>
              <button onClick={removePunctuation} title={t('text.removePunctuation')} className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={handleCopy}
                  className="text-sm text-gray-600 hover:text-gray-900 flex items-center px-2 py-1 rounded hover:bg-gray-100 transition-colors"
                >
            ...
            <textarea
              ...
              className="flex-1 w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-800 resize-none shadow-sm text-base leading-relaxed"
            ...
            <div className="mt-4 bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-sm font-bold text-gray-700">{t('text.findReplace')}</h4>
              </div>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  ...
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.words')}</div>
                </div>
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  <div className="text-xl font-bold text-purple-600">{stats.characters}</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.chars')}</div>
                </div>
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  <div className="text-xl font-bold text-purple-600">{stats.lines}</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.lines')}</div>
                </div>
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  <div className="text-xl font-bold text-purple-600">{stats.sentences}</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.sentences')}</div>
                </div>
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  <div className="text-xl font-bold text-purple-600">{stats.paragraphs}</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.paragraphs')}</div>
                </div>
                <div className="bg-white p-3 rounded-lg shadow-sm text-center">
                  <div className="text-xl font-bold text-purple-600">~{stats.readingTimeMin}m</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mt-1">{t('text.readingTime')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-gray-900">{t('text.advancedStats')}</h3>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 shadow-sm">
                ...
                {stats.emails.length > 0 && (
                  <div className="mb-4">
                    ...
                    <div className="bg-white rounded-lg border border-blue-100 p-2 max-h-32 overflow-y-auto text-sm">
                      {stats.emails.map((email, i) => (
                        <div key={i} className="text-gray-700 py-1 border-b border-gray-50 last:border-0 truncate">{email}</div>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div>
                    ...
                    <div className="bg-white rounded-lg border border-blue-100 p-2 max-h-32 overflow-y-auto text-sm">
                      {stats.urls.map((url, i) => (
                        <div key={i} className="text-gray-700 py-1 border-b border-gray-50 last:border-0 truncate">
